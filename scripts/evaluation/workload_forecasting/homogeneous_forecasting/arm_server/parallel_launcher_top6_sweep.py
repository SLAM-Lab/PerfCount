...
# =========================================================
MACHINE    = "arm_server"
VARIANT    = "top6"        # used in log/model paths to separate from full sweep
MAX_WORKERS = 70
EPOCHS     = 100
MEM_PER_JOB_GB = 2
...
# TODO: replace with finalised cross-frequency top-4 counters once 2GHz/3GHz analysis is done.
# 1GHz candidates (top-4): stalled_cycles_backend, branch_misses, l2d_cache_refill, stalled_cycles_frontend
COUNTERS = "cpu_cycles instructions stalled_cycles_backend branch_misses l2d_cache_refill stalled_cycles_frontend".split()
