...
# x86 P-Core (cpu0) native 23-counter set
COUNTERS_NATIVE = (
...
# Shared 21-counter set (E-core's counters), used for cross_proc so donor
# files from either core always have all required columns
COUNTERS_SHARED = (
    "cpu_cycles branch_load_misses branch_loads branch_misses branches bus_cycles "
    "cache_misses cache_references dtlb_load_misses dtlb_loads dtlb_store_misses "
