...
#        df8.to_csv('df8.csv',sep=',',index=False)
        ...
        df9 = pandas.merge(df7, df5, on = 'time', how='inner')
...
#        print(df9)
        ...
        if initial_read == 0:
            ...
            df9 = df9.drop(columns=['cpu_atom/instructions/u'])
            merged_df = pandas.merge(merged_df, df9, on = 'time', how = 'inner')
#        print(merged_df)
